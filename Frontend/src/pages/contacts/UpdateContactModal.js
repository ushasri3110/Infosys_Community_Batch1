...
function UpdateContactModal({open,close,contact}) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        dispatch(updateContact(contact.emergencyId,formData));
        close();
        setFormData({
            personName: "",
            serviceType: "",
    ...
    <Modal open={open} onClose={close}>
        <Box sx={style}>
            ...
            <form className='flex flex-col space-y-3' onSubmit={handleSubmit}>
                ...
                <input type="text" name="block" placeholder="Enter email here..." className='border border-gray-300 shadow-lg p-1 rounded-md focus:outline-none' required onChange={handleChange} value={formData.block}/>
